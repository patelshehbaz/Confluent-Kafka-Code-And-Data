...
kafka_config = {
    ...
    'sasl.username': 'UEL5PGBY2JJMEUWK',
    'sasl.password': 'K3p/vVVrCV8QEvvg+R/o6ZL+ZftVEYxoYVbq2Q0xzvZ6fZwhtqwPNkXI+KBSBEx/'
}

# Create a Schema Registry client
schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-kg7rp.westus2.azure.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('H2ZFGMPTHZ6EBSXV', '74DquiH5X+3HJK9hfiD5LJoiSZiXhmLJejPdOYGu8HqfyCqVdfNeieYCbBJ7/k+r')
})
